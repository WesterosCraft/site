...
export const AlternatingFeature = () => {
  const getDirection = (i: number) =>
    i % 2 === 0 ? 'flex-col-reverse lg:flex-row' : 'flex-col-reverse lg:flex-row-reverse'

  return (
    <ContainerBorder className="pb-24 sm:pb-32 px-4 md:px-10 gap-16 lg:gap-24">
      {features.map((feat, index) => (
        <div key={index} className={`flex ${getDirection(index)} gap-0 lg:gap-12`}>
          <motion.div
